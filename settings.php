...
/* **********************************************************************************************
   ...
   Copyright 2010-2014 Justin Edwards
...
$updated = false;
$promotion_image_link = "http://eddicted.co.uk/images/logo_vector_less.png?";
$pro_promote = true; // StdTweak
//$pro_promote = false; // ProTweak
$pro_promote_feature = "(this feature is only available in the <a href='http://www.eddicted.co.uk/cs/products/'>Pro Version</a>)"; // StdTweak
...
if ($value_helpimprove == 1) {
    $promotion_image_link = $promotion_image_link."blog=".get_bloginfo('url')."&storeid=".$value_storeid;
}
?>
<?php if ($updated == true) : ?>
...
<div class="wrap">
    ...
    <tr><td style="width:50%; vertical-align:top">
        ...
        <a href="http://www.eddicted.co.uk/cs/products/"><img src="<?php echo $promotion_image_link ?>" title="Eddicted"/></a>
        <p>This plugin is developed by <a href="http://www.eddicted.co.uk/cs/products/">Eddicted</a>.<br/>
        <p><a href="http://www.eddicted.co.uk/cs/products/">Upgrade to the Pro version</a> and get great extra features.<br/>
        <a href="http://www.eddicted.co.uk/cs/products/">Eddicted</a> is not associated with <a href="http://www.romancart.com/">RomanCart Ltd</a>.</p>
...
<?php if ($pro_promote==true) { ?>
        ...
        <p>
        The <a href="http://www.eddicted.co.uk/cs/products/">Pro-Version</a> is available
        <a href="http://www.eddicted.co.uk/cs/products/">on our website</a>
        </p>
<?php } ?>
    </td></tr>
    </table>
